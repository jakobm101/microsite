...
$( document ).ready(function() {
  ...
  p_middleTop = new Vector(c.width/2, c.height/2 - 200);
  p_middleBottom = new Vector(c.width/2, c.height/2 + 200);

  middleOffset = new Vector(0, 200);
...
function updateGradients(){
  ...
  gradient1 = ctx.createLinearGradient(p_topLeft_movable.x, p_topLeft_movable.y, p_middleBottom.x, p_middleBottom.y);
  ...
  gradient3 = ctx.createLinearGradient(p_middleTop.x, p_middleTop.y, p_bottomRight_movable.x, p_bottomRight_movable.y);
  ...
  gradient4.addColorStop(0, "#ffeb1e");
  gradient4.addColorStop(1, "#20d591");
}
